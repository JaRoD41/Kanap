...
fetch("http://localhost:3000/api/products/") //requete de l'API afin d'importer les données des canapés
  ...
  .then (data => {      //les données JSON sont nommées "data" pour être exploitées en tant que tableau
    for(let champ of data){ //boucle pour importer chaque champ du JSON et lui attribuer une variable
